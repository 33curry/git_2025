...
### 方式二：使用 `git reset` 和 `git checkout`
...
```
![2025-11-09 15-54-19 的屏幕截图](3.png)

![5](/home/thunder/git_homework/git_2025/2025-finalproject/2.png)
...
-   接下来可以再合并分支
-   ![2025-11-09 17-06-29 的屏幕截图](9.png)
...
```
![2025-11-09 16-28-39 的屏幕截图](4.png)
...
git push --force-with-lease origin master
```
![2025-11-09 16-31-17 的屏幕截图](6.png)
...
```
![2025-11-09 17-23-12 的屏幕截图](11.png)
...
![2025-11-09 16-44-52 的屏幕截图](8.png)
