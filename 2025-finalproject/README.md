...
- 通过 Pull Request 的方式提交到 [课程仓库](https://github.com/gdut-dynamic-x/missing-semester)，具体位置为 `2025-finalproject` 文件夹下以你 GitHub ID 命名的文件夹
...
1. 第一阶段要求在 11 月 7 日 21:00 前开启你的 PR
